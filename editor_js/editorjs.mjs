...
function be(s, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const a = "Editor.js 2.28.2", l = 'line-height: 1em;color: #006FEA;display: inline-block;font-size: 11px;line-height: 1em;background-color: #fff;padding: 4px 9px;border-radius: 30px;border: 1px solid rgba(56, 138, 229, 0.16);margin: 4px 5px 4px 0;';
      ...
      function A(b, g) {
        ...
        if (b.insertAt === "top")
          ...
          if (typeof b.insertAt != "object" || !b.insertAt.before)
            throw new Error("[Style Loader] Invalid value for parameter 'insertAt' ('options.insertAt') found. Must be 'top', 'bottom', or Object.(https://github.com/webpack-contrib/style-loader#insertat)");
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          ...
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(M) {
            ...
            (W.convertToAbsoluteUrls || Mt) && (Q = k(Q)), Ee && (Q += "/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(Ee)))) + " */");
...
class Te {
  /**
   * @class
   * @param {HTMLElement} workingArea — editors working node
   */
  constructor(e) {
...
class Go extends C {
  ...
  /**
   * Split current Block
   * 1. Extract content from Caret position to the Blocks end
...
const wt = class extends C {
  ...
  /**
   * Get and process tools paste configs
   */
  processTools() {
  ...
  (function(t, o) {
    ...
    return function(t) {
      ...
      function v(y, x, w) {
        ...
        if (R ? y.setAttribute("media", R) : y.removeAttribute("media"), b && btoa && (I += "/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(b)))), " */")), y.styleSheet)
      ...
      (o = i(3)(!1)).push([t.i, '.ce-paragraph {line-height: 1.6em;outline: none;}.ce-paragraph[data-placeholder]:empty::before{content: attr(data-placeholder);color: #707684;font-weight: normal;opacity: 0;}.codex-editor--empty .ce-block:first-child .ce-paragraph[data-placeholder]:empty::before {opacity: 1;}.codex-editor--toolbox-opened .ce-block:first-child .ce-paragraph[data-placeholder]:empty::before,.codex-editor--empty .ce-block:first-child .ce-paragraph[data-placeholder]:empty:focus::before {opacity: 0;}.ce-paragraph p:first-of-type{margin-top: 0;}.ce-paragraph p:last-of-type{margin-bottom: 0;}', ""]), t.exports = o;
    }, function(t, o, i) {
